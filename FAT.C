...
{
        0x31, 0xC0, 0x8E, 0xD8, 0x8E, 0xC0, 0x8E, 0xD0, 0xBC, 0x00, 0x7C, 0xBE, 0x61, 0x7C, 0xB4, 0x0E, 
    0xAC, 0x3C, 0x55, 0x74, 0x04, 0xCD, 0x10, 0xEB, 0xF7, 0xB8, 0x03, 0x02, 0xB9, 0x02, 0x00, 0xB6, 
    0x00, 0xBB, 0x80, 0x7C, 0xCD, 0x13, 0xEA, 0x80, 0x7C, 0x00, 0x00, 0x38, 0x22, 0x20, 0x66, 0x6C, 
    0x6F, 0x70, 0x70, 0x79, 0x3A, 0x20, 0x42, 0x6F, 0x6F, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x70, 
...
void WriteBootCode()
{
  ...
  if (nSectorSize < 512)
  {
    ...
    if (nSectorSize == 256)
    {
      ...
      s128ByteBootstrapper[26] = 0x01; //was 0x03
      s128ByteBootstrapper[35] = 0x7D; //was 0x7c
      s128ByteBootstrapper[34] = 0x00; //was 0x80
    }
...
void WriteRootDir()
{
  ...
  unsigned char nSectorIdx = (unsigned char)(*pReservedSectors) + 1;
